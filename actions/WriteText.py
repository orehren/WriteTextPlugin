...
class WriteText(ActionBase):
    ...
    def _setup_xkb(self):
        try:
            ...
            keymap_str = xkb.Keymap.get_as_string(xkb.Keymap(self.xkb_context, xkb.KEYMAP_FORMAT_TEXT_V1), xkb.KEYMAP_FORMAT_TEXT_V1)
            self.xkb_keymap = xkb.Keymap.from_string(self.xkb_context, keymap_str, xkb.KEYMAP_FORMAT_TEXT_V1, xkb.KEYMAP_COMPILE_NO_FLAGS)
